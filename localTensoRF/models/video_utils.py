...
from dataLoader.base import SplitWrapper
from models.metrics import compute_psnr
from models.radiance_field import DensityField, RadianceField
...
def save_seperate_videos(
    ...
    for key in keys:
        ...
        if num_timestamps == 1:  # it's an image
            ...
            writer = imageio.get_writer(tmp_save_pth)
        else:
