python scripts/run_flow.py --data_dir /data/ljf/localrf/kitti/sequences/04
...
python DPT/run_monodepth.py --input_path /data/ljf/localrf/kitti/sequences/04/image_2 --output_path /data/ljf/localrf/kitti/sequences/04/depth --model_type dpt_large
